...
Helm Chart for the keptn skywalking-service


## Configuration

The following table lists the configurable parameters of the skywalking-service chart and their default values.

| Parameter                | Description             | Default        |
| ------------------------ | ----------------------- | -------------- |
| `image.repository` | Container image name | `"ghcr.io/strrl/skywalking-service"` |
| `image.pullPolicy` | Kubernetes image pull policy | `"IfNotPresent"` |
| `image.tag` | Container tag | `""` |
| `service.enabled` | Creates a kubernetes service for the skywalking-service | `true` |
